...
BBGame._pad=function( i ){
	return i<10 ? "0"+i : ""+i;
}

BBGame._months=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];
...
BBGame.prototype.CurrentDate=function(){
	var now=new Date();
	return BBGame._pad( now.getDate() )+" "+BBGame._months[ now.getMonth() ]+" "+now.getFullYear();
}

BBGame.prototype.CurrentTime=function(){
	var now=new Date();
	return BBGame._pad( now.getHours() )+":"+BBGame._pad( now.getMinutes() )+":"+BBGame._pad( now.getSeconds() );
}
