...
Class Image
	...
	Method WritePixels( pixels[],x,y,width,height,offset=0,pitch=0,relative?=True )
...
#End
		If relative
			device.WritePixels2 surface,pixels,x+frames[0].x,y+frames[0].y,width,height,offset,pitch
		Else
